...
CSV = SimpleCSVLoader(
    index_col=False, skipinitialspace=True, usecols=cols, scheduler=s, throttle=100
)
...
stext.create_dependent_modules(
    CSV, hist=some_cols, min_=True, max_=True, var=True, distinct=True, corr=True
)
aio.run(s.start())
