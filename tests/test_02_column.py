...
class TestColumn(ProgressiveTest):
    def test_column(self):
        index = IdColumn()
        self.assertEqual(len(index.freelist()), 0)
        self.assertEqual(index.freelist_size(), 0)
        self.assertTrue(index.is_identity)
        self.assertEqual(index.last_id, 0)
        ...
        self.assertIsInstance(col2a.index, IdColumn)
