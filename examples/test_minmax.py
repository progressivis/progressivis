...
try:
    ...
    s = Scheduler()
csv = CSVLoader('../nyc-taxi/yellow_tripdata_2014-10.csv.bz2', index_col=False,skipinitialspace=True,usecols=['pickup_longitude', 'pickup_latitude'], filter=filter, engine='c',scheduler=s)
#csv = RandomTable(columns=['pickup_longitude', 'pickup_latitude'],rows=1000000, scheduler=s)
