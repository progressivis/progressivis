html_ =  `<!-- Tab panes -->
  ...
  <!--div id="heatmapContainer" style="visibility: hidden;"></div-->
    <!-- Modal MDM form -->

    <div id="modal-mdm-form" style="display: none;">
    ...
    <script>
    $("#modal-mdm-form").attr("style", "display: block;");
   </script>
<script src="https://unpkg.com/babel-standalone@6/babel.min.js"></script>
    <script type="text/babel">
      funct_ion getOnly(dict, keys){
      var res = {};
