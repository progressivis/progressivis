...
cdef extern from "khash_python.h":
    ...
    void kh_del2_int64(kh_int64_t*, khint_t)    
    ...
    kh_strbox_t* kh_init_strbox()
    void kh_destroy_strbox(kh_strbox_t*)
    void kh_clear_strbox(kh_strbox_t*)
    khint_t kh_get_strbox(kh_strbox_t*, kh_cstr_t)
    void kh_resize_strbox(kh_strbox_t*, khint_t)
    khint_t kh_put_strbox(kh_strbox_t*, kh_cstr_t, int*)
    void kh_del_strbox(kh_strbox_t*, khint_t)
