napoleon_type_aliases = {
    ...
    'Min': ":class:`Min <progressivis.stats.min.Min>`",
    'Max': ":class:`Max <progressivis.stats.max.Max>`",
    'Histogram1D': ":class:`Histogram1D <progressivis.stats.histogram1d.Histogram1D>`",
