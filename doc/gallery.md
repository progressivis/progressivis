...
The notebook shown below is downloadable [here](https://github.com/progressivis/ipyprogressivis/blob/main/notebooks/mb_kmeans_taxis.ipynb).
You can display this example in a <a href="_static/mb_kmeans_taxis.html" target=_blank>new tab</a>.

```{eval-rst}
.. raw:: html

   <iframe src="_static/mb_kmeans_taxis.html" height="2000px" width="100%"></iframe>
